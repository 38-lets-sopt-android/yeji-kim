...
fun Greeting2(name: String, modifier: Modifier = Modifier) {
    Column(
        ...
        Text(text = "이메일로 로그인", fontSize = 20.sp, color = Color(0xFFFFFFFF), fontWeight = FontWeight.Bold)
        ...
        Text(text = "아직 계정이 없으신가요? 회원가입", fontSize = 14.sp, color = Color(0xFF999999),
            modifier = Modifier
                .align(Alignment.CenterHorizontally)
                .clickable(onClick = {
        ...
        Button(
            onClick =  { if(mail == realmail && password == realpassword) {
